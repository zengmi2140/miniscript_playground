...
ScriptWise is under active development. Issues, suggestions, bug reports, documentation improvements, and small pull requests are welcome.

This project is primarily maintained by a solo developer. Internal notes are written in Chinese, but English issues and contributions are welcome.
