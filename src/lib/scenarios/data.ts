...
export const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    description: {
      zh: "需要 Alice 与 Bob 共同签名协作花费；资金未移动达 1000 个区块后，可由 Charlie 单独花费。",
  ...
  },
  {
    ...
    title: {
      zh: "恢复密钥（灾备密钥）",
      en: "Recovery Key (Disaster Backup Key)",
    },
    description: {
      zh: "主密钥可以单独花费；资金未移动达 10000 个区块后，可用恢复密钥单独花费。",
  ...
  },
  {
    ...
    description: {
      zh: "哈希时间锁合约：乙方通过揭晓原像取款；如两周内未取款，甲方可将资金撤回。",
  ...
  },
  {
    id: "dlc-simple",
    icon: "ShieldCheck",
    title: { zh: "DLC 合约", en: "DLC Contract" },
    description: {
      zh: "基于预言机签名的谨慎日志合约：根据预言机可以见证的事件设定有条件支付。",
  ...
  },
  {
    ...
    description: {
      zh: "资金存入后必须再经过约三年（157,680 个区块）才能凭签名花费。",
