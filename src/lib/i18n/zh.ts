export const zh = {
  home: {
    ...
    hook: {
      eyebrow: "真实世界的资产控制难题",
      q1: "想给家人留一笔比特币，如何安排继承方案？",
      q2: "三把密钥中任意一把丢失，2-of-3 多签是否还能正常工作？",
      q3: "委托第三方保管资产的同时，如何在紧急情况下收回控制权？",
    ...
    meetMiniscript: {
      ...
      features: {
        ...
        composability: {
          ...
          benefit1: {
            title: "独立的基础单元",
            desc: "签名（pk）、时间锁（older）、哈希锁（sha256），每一个都是独立条件，任意嵌套组合都合法。",
          },
          benefit2: {
            title: "嵌套不会变差",
          ...
          benefit3: {
            title: "结构化 = 可分析",
            desc: '工具能自动回答"这段脚本有哪些花费路径、每条路径开销多大"——详情请见本网站 Playground。',
          },
        },
  ...
  builder: {
    ...
    sync: {
      textLed:
        "当前 Policy 包含构建器不支持的语法（如 after() 或哈希锁），画布显示上次同步的快照",
      compileError:
