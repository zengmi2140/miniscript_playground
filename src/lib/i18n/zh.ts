export const zh: Record<string, string> = {
  ...
  // Builder
  'builder.starter.title': '选择起手模板',
  'builder.starter.subtitle': '从一个常见模式开始，然后自定义你的策略',
  ...
  'builder.starter.recovery': '带恢复路径',
  'builder.starter.recoveryDesc': '主密钥 + 时间锁恢复',
  'builder.sync.textLed': '当前 Policy 包含构建器不支持的语法（如 after() 或哈希锁），画布显示上次同步的快照',
  'builder.sync.compileError': 'Policy 有语法错误，画布显示上次成功编译的结果',
  ...
  'builder.empty.title': '选择一个起手模板',
  'builder.empty.subtitle': '点击下方卡片开始构建你的策略',
