...
export const zh: Record<string, string> = {
  ...
  'footer.description': '一个以场景为先、以花费路径为中心的 Miniscript 教育实验室',
  'footer.rights': 'Miniscript Lab',
  'flow.rootLabel': '花费条件',
  'flow.andLabel': '全部满足',
  'flow.orLabel': '满足其一',
  'glossary.tooltip.label': '这是什么',
  'playground.mobile.title': '请使用桌面或更大屏幕',
  'playground.mobile.description': '完整的 Playground —— 三栏布局和可视化构建器 —— 需要更宽的视口。请在桌面、笔记本或横屏平板上打开，以获得完整体验。',
  'playground.mobile.goScenarios': '浏览场景',
  'compare.featureList.title': '计划功能',
  'compare.feature.1': '两个 Policy 的并排编译结果',
  'compare.feature.2': '花费路径的可视化 diff',
  'compare.feature.3': '脚本大小与费用对比',
  'compare.feature.4': '导出 Markdown / JSON 报告',
  'compare.comingSoon': '对比模式即将推出',
  'compare.description': '两个 Policy 的编译结果和花费路径并排对比',
  'playground.left.scenarios': '场景',
  'playground.left.diy': '自己动手',
  'playground.left.diyDesc': '自由组合花费条件，设计你自己的策略',
  'playground.left.diyComingSoon': '即将推出',
  'playground.left.keysPlaceholder': '选择场景后会自动填充密钥变量',
  'playground.keys.empty': '暂无密钥变量',
  'playground.keys.hint': 'MVP 使用压缩公钥（66 位十六进制，用于 P2WSH）',
  ...
  'playground.context.comingSoon': '即将推出',
  'playground.center.compilePlaceholder': '编译后这里会显示路径图',
  'playground.center.staleWarning': 'Policy 有语法错误。这里显示最后一次成功编译的结果。',
  'playground.center.hasError': '编译失败。请检查左侧 Policy 语法。',
  'playground.right.waiting': '正在等待编译…',
  'playground.right.tabPlaceholder': '编译结果会显示在这里',
  ...
  'playground.results.address': '地址',
  'playground.results.paths': '花费路径',
  'playground.results.panelNav': '结果面板',
  'playground.results.explain': '这是什么？',
  'playground.results.stale': '过期',
  'playground.stack.title': 'Script VM',
  'playground.stack.comingSoon': '即将推出',
  'playground.empty.title': '输入 Policy 或选择一个场景',
  'playground.empty.subtitle': '开始探索比特币花费路径',
  'playground.paths.empty': '当前没有可用的花费路径。所有路径在当前条件下都不可满足。',
