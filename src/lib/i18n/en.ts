export const en = {
  home: {
    hero: {
      ...
      title:
        "Miniscript: make Bitcoin spending conditions readable, analyzable, composable",
      intro1:
        "A structured language — it lifts multisig, timelocks, and hashlocks out of opaque opcodes.",
      intro2:
      ...
      ctaPrimary: "Start with a Real Scenario ↓",
      ctaSecondary: "Open the Playground",
      desktopHint:
        "For the full experience, open the Playground on a desktop or larger screen.",
      card: {
        tag: "P2WSH",
        compilesTo: "↓ compiles to",
        statusNote: "Example: compilation demo",
        replay: "↻ Replay",
      },
    ...
    meetMiniscript: {
      ...
      subtitle:
        "Bitcoin Script already has enough expressive power — the real bottleneck is how you write it. Miniscript doesn't change Bitcoin; it simply offers a better way to write Bitcoin scripts.",

      definition: {
        title: "What is Miniscript",
        calloutStrong:
          "Miniscript — a compilable, verifiable, composable intermediate language.",
        calloutBody:
        ...
        pipeline: {
          ...
          script: {
            ...
            role: "How the chain executes it",
      ...
      features: {
        ...
        readability: {
          ...
          policyExample:
            "thresh(2,\n  pk(Alice),\n  pk(Bob),\n  pk(Charlie)\n)",
          compareNote:
            "Both express 2-of-3 multisig. The Miniscript policy on the right explicitly defines a 'threshold' of 2, whereas the Bitcoin Script on the left requires understanding stack operations and opcode semantics.",
          takeaway:
        ...
        composability: {
          ...
          benefit1: {
            ...
            desc: "Signature (pk), timelock (older), hashlock (sha256) — each is an independent condition, and any nested combination remains valid.",
          },
          benefit2: {
          ...
          benefit3: {
            ...
            desc: 'Tools can automatically answer "what are the spending paths, and how expensive is each?" — see our Playground for details.',
          },
        },
    ...
    wallets: {
      label: "Ecosystem",
      title: "Wallets That Support Miniscript",
      subtitle:
        "These software and hardware wallets have native Miniscript support for managing complex spending conditions.",
    ...
    faq: {
      ...
      items: {
        ...
        q5: {
          ...
          a: "Miniscript describes the structure of spending conditions; a Descriptor takes that and adds concrete keys and derivation paths, giving wallets everything they need to derive addresses and build transactions. Think of it as: Descriptor = Miniscript + keys + derivation paths.",
        },
        q6: {
    ...
    cta: {
      ...
      primary: "Build in the Playground",
      secondary: "Read the learning resources",
      desktopHint:
        "For the full experience, open the Playground on a desktop or larger screen.",
    },
  ...
  intro: {
    applications: {
      ...
      tryIt: "Try it",
      subtitle:
        "From Policy to on-chain script: watch the full compilation pipeline for real-world scenarios.",
  ...
  builder: {
    starter: {
      ...
      subtitle:
        "Pick a root node type; add more conditions on the canvas afterward.",
    ...
    op: {
      ...
      all: {
        label: "All Required",
        desc: "All conditions must be satisfied (AND)",
      },
      any: {
        label: "Either One",
        desc: "Either of the two conditions is enough (OR)",
      },
      threshold: {
        label: "Threshold",
    ...
    confirm: {
      ...
      deleteRoot:
        "Delete the entire policy? This will reset the canvas to its initial state.",
      cancel: "Cancel",
      confirm: "Delete",
    },
    wrap: {
  ...
  playground: {
    ...
    share: {
      invalidPayload:
        "Could not restore from this share link. It is invalid or exceeds the size limit.",
    },
    error: {
      hints: "Suggestions",
    ...
    center: {
      ...
      hasError:
        "Compilation failed. Please check the Policy syntax on the left.",
    },
    right: {
    ...
    paths: {
      empty:
        "No spending paths available. All paths are unsatisfiable under current conditions.",
      malleable: "Malleable",
    ...
    address: {
      warning: "This address is for testnet only. Do not use on mainnet.",
    },
    mobile: {
  ...
  footer: {
    description:
      "A scenario-first, spending-path-centered Miniscript educational playground",
    rights: "ScriptWise",
  },
  ...
  resources: {
    toolsDoc: {
      ...
      subtitle:
        "Official sites, reference implementations, online playgrounds, and SDKs.",
    },
    reading: {
      ...
      articles: {
        ...
        nunchuk101: {
          title: "Miniscript 101: A Technical Guide",
          source: "Nunchuk",
        },
        bitboxP1: {
          title:
    ...
    links: {
      ...
      minsc: {
        ...
        title: "Minsc",
        desc: "A Miniscript Policy-based scripting language with variables, functions, and infix syntax; the live WASM compiler outputs Policy, Miniscript, script, and addresses on testnet.",
      },
      miniscriptBip: {
        badge: "BIP standard",
