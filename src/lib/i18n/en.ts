export const en = {
  home: {
    ...
    meetMiniscript: {
      ...
      subtitle:
        "Bitcoin Script already has enough expressive power — the real bottleneck is how you write it. Miniscript doesn't change Bitcoin; it simply innovates the way Bitcoin scripts are written.",
