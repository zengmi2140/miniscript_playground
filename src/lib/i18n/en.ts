export const en: Record<string, string> = {
  ...
  'home.cta.subtitle': 'Use the visual canvas in the Playground to compose a policy and see Policy, Miniscript, and spending paths in real time.',
  ...
  'builder.sync.compileError': 'Policy cannot be compiled or parsed. The canvas is read-only. If nothing has compiled successfully yet, you see the initial placeholder; fix the Policy to resync.',
  ...
  'builder.op.binaryTrimNotice': 'Switched to AND/OR: only the first two child conditions were kept.',
  ...
  'playground.mobile.description': 'The full Playground — three-column layout and visual builder — needs a wider viewport. Open it on a desktop, laptop, or a tablet in landscape for the full experience.',
  ...
  'resources.links.bdk.desc': 'A popular SDK for wallet functionality in applications; docs and examples cover Descriptors, PSBT, and Miniscript-related workflows.',
  'resources.links.miniscript.desc': 'Documentation and tooling by Pieter Wuille: language overview, online compiler, analyzer, type system, and usage notes.',
  'resources.links.rust.desc': 'The widely used Rust implementation:',
};