export const en: Record<string, string> = {
  ...
  'resources.links.rust.desc':
    'The widely used Rust implementation: compiler, satisfiability analysis, and extensive tests—ideal for reading source and production integrations.',
  'resources.links.studio.badge': 'Online tool',
  'resources.links.studio.title': 'Miniscript Studio',
  'resources.links.studio.desc':
    'In-browser Policy/Miniscript workbench: examples from basics to Taproot, embedded Policy & Miniscript references, spending-path analysis, and shareable URLs (local storage; use public keys only).',
  'resources.links.minsc.badge': 'Language & playground',
  ...
  'resources.links.bdk.desc':
    'A popular SDK for wallet functionality in applications; docs and examples cover Descriptors, PSBT, and Miniscript-related workflows.',
