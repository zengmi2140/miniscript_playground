    ...
    >
      ...
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-sm font-semibold text-text-primary">
          {mode === 'root-type-select' && t('builder.starter.title')}
          {mode === 'add-child' && t('builder.node.addChild')}
          ...
          {mode === 'confirm-delete' && t('builder.confirm.title')}
        </h3>
        <button
          onClick={handleClose}
      ...
      {mode === 'root-type-select' && (
        <div className="space-y-2">
          <p className="text-xs text-text-muted mb-3">{t('builder.starter.subtitle')}</p>
          <button
          ...
          >
            ...
            <div>
              <p className="text-sm font-medium text-text-primary">{t('builder.starter.singleControl')}</p>
              <p className="text-xs text-text-muted">{t('builder.starter.singleControlDesc')}</p>
            </div>
          </button>
          <button
          ...
          >
            ...
            <div>
              <p className="text-sm font-medium text-text-primary">{t('builder.starter.sharedControl')}</p>
              <p className="text-xs text-text-muted">{t('builder.starter.sharedControlDesc')}</p>
            </div>
          </button>
          <button
          ...
          >
            ...
            <div>
              <p className="text-sm font-medium text-text-primary">{t('builder.node.all')}</p>
          ...
          >
            <div className="flex h-5 w-5 items-center justify-center text-btc-500 font-bold text-xs">|</div>
            <div>
              <p className="text-sm font-medium text-text-primary">{t('builder.node.any')}</p>
